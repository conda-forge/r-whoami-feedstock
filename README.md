...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-whoami-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-whoami-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-whoami-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-whoami-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-whoami-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-whoami-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-whoami` can be installed with:

```
conda install r-whoami
```

It is possible to list all of the versions of `r-whoami` available on your platform with:
